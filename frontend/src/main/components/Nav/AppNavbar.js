          ...
          <Navbar.Collapse>
            ...
            <Nav className="me-auto">
              ...
              {hasRole(currentUser, 'ROLE_USER') && (
                <NavDropdown
                  title="Help Requests"
                  id="appnavbar-help-requests-dropdown"
                  data-testid="appnavbar-help-requests-dropdown"
                >
                  <NavDropdown.Item
                    as={Link}
                    to="/helpRequests/list"
                    data-testid="appnavbar-help-requests-list"
                  >
                    List
                  </NavDropdown.Item>
                  <NavDropdown.Item
                    as={Link}
                    to="/helpRequests/create"
                    data-testid="appnavbar-help-requests-create"
                  >
                    Create
                  </NavDropdown.Item>
                </NavDropdown>
